...
python /home/omt4002/keymorph/scripts/run.py \
    ...
    --save_dir /midtier/sablab/scratch/omt4002/keymorph/expriments/training_real_world_coordinates_CT \
    --visualize \
    --use_amp \
    ...
    --epochs 20000 \
    --load_path /midtier/sablab/scratch/omt4002/keymorph/expriments/pretraining_real_world_coordinates_CT/__pretrain__pretrain_CT_numlevels5_same_mod_training_128_power_weighted_keypoints128_batch1_lr3e-06/checkpoints/pretrained_epoch15000_model.pth.tar